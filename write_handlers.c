 ...
 * @ind: The index on which the number starts on the buffer
 * @buffer: A buffer
 * @flags: Flags
 * @width: The width
 ...
 * @is_negative: A number which indicates if the num is negative
 * @ind: The index through which the number starts in the buffer
 * @buffer: An array of characters
 * @flags: Flags specifiers
 * @width: The width of specifier
 * @precision: Precise specifier
 * @size: Size of specifier
 *
 * Return: A number of written characters
 */
 ...
 * @ind: The index from which the number starts in the buffer
 * @length: Length of number
 * @width: Width of specifier
 * @flags: The flag specifier
 * @padd: Character which represents the padding
 * @extra_c: A char representing another extra character
 * @padd_start: Index at which padding should start
 *
 * Return: A number of written charsacters
 */
